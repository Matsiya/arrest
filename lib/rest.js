 ...
 *
 /* this.options.couchBaseRest object properties changed 15.05.2014
 */
...
RestCouchBaseAPI.prototype.query = function(bucket, ddoc, view, auth, query, cb) {
    ...
    var options = {
        uri: this.options.couchBaseRest.host + "/" + bucket + "/_design/" + ddoc + "/_view/" + view,
        method: 'GET',
        qs : query
    };
...
RestCouchBaseAPI.prototype.get = function(key, bucket, auth, cb) {
    ...
    var options = {
        uri: this.options.couchBaseRest.host + "/" + bucket + "/" + key,
        method: 'GET'
    };
...
RestCouchBaseAPI.prototype.save = function(id, datas, bucket, auth, cb) {
    ...
    var options = {
        uri: this.options.couchBaseRest.host +'/'+ bucket + '/' + id,
        method: 'PUT',
        json: datas
    };
